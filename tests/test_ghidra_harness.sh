...
javac --release 21 -d "$BUILD/classes" \
  ...
  "$ROOT/src/main/java/turboheader/il2cpp/types/GhidraTypeImporter.java" \
  "$ROOT/tests/java/turboheader/il2cpp/types/GhidraImporterHarnessTest.java" \
  "$ROOT/tests/java/turboheader/il2cpp/types/GhidraImporterIntegrityTest.java" \
  "$ROOT/tests/java/turboheader/il2cpp/types/CorpusModelValidation.java" \
  "$ROOT/tests/ghidra_scripts/VerifyTurboHeaderFixture.java"
java -cp "$BUILD/classes" turboheader.il2cpp.types.GhidraImporterIntegrityTest
NATIVE_LIBRARY="$(find_native_library "$ROOT/native/build-clean")"
java -Dturboheader.il2cpp.native="$NATIVE_LIBRARY" \
  -cp "$BUILD/classes" turboheader.il2cpp.types.GhidraImporterHarnessTest \
